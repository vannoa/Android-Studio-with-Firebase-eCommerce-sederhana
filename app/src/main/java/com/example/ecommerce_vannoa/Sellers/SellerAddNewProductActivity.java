...
public class SellerAddNewProductActivity extends AppCompatActivity {
    ...
    private String CategotyName, Description, Price, Pname, saveCurrentDate, saveCurrentTime;
                ...
                Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        if (task.isSuccessful()){
                            ...
                            Toast.makeText(SellerAddNewProductActivity.this, "Product image url succesfully!", Toast.LENGTH_SHORT).show();
    ...
    private void SaveProductInfoToDatabase(){
        ...
        productMap.put("category", CategotyName);
        ...
        ProductsRef.child(productRandomKey).updateChildren(productMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    ...
                    loadingBar.dismiss();
                    Toast.makeText(SellerAddNewProductActivity.this, "Product id added successfully!", Toast.LENGTH_SHORT).show();
                }else {
                    loadingBar.dismiss();
