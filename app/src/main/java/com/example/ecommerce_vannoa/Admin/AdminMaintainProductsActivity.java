...
import com.example.ecommerce_vannoa.Sellers.SellerProductCategoryActivity;
    ...
    private void deleteThisProduct() {
        productRef.removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                Toast.makeText(AdminMaintainProductsActivity.this, "The product is successfully!", Toast.LENGTH_SHORT).show();
            }
        });
    }
