package com.example.ecommerce_vannoa.Buyers;
...
import com.example.ecommerce_vannoa.Model.Cart;
import com.example.ecommerce_vannoa.Prevalent.Prevalent;
import com.example.ecommerce_vannoa.R;
import com.example.ecommerce_vannoa.ViewHolder.CartViewHolder;
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Cart, CartViewHolder> adapter
            ...
            protected void onBindViewHolder(@NonNull CartViewHolder holder, int position, @NonNull final Cart model) {
                ...
                int oneTprcProductTprice = ((Integer.valueOf(model.getPrice()))) * Integer.valueOf(model.getQuantity());
                overTotalPrice = overTotalPrice + oneTprcProductTprice;
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()){
                    ...
                    if (shippingState.equals("shipped")){
                        txtTotalAmount.setText("Dear "+userName+"\n orders is shipped successsfully!");
