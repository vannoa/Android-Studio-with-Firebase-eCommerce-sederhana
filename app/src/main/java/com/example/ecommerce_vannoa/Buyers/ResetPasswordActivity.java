...
public class ResetPasswordActivity extends AppCompatActivity {
    ...
    private TextView pageTitle, titlteQuestion;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titlteQuestion = (TextView) findViewById(R.id.title_questions);
    ...
    protected void onStart() {
        ...
        if (check.equals("settings")){
            ...
            titlteQuestion.setText("Please set answer for the following security question!");
